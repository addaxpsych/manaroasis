-- ═══════════════════════════════════════════════════════════
-- واحة د. منار مبارز — full schema
--
-- Generated from supabase/migrations/*.sql.
-- Paste into the Supabase SQL editor and Run.
--
-- Safe to run more than once: tables use IF NOT EXISTS, functions use
-- OR REPLACE, policies are dropped before being recreated, and the seed
-- skips any course that already has modules.
--
-- Afterwards run supabase/VERIFY.sql — every row should say PASS.
-- ═══════════════════════════════════════════════════════════
